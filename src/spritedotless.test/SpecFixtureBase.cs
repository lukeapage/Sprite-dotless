namespace dotless.Test
{
    ...
    public class SpecFixtureBase
    {
        ...
        protected Env AssertLess(string input, string expected)
        {
            return AssertLess(input, expected, DefaultParser());
        }

        protected Env AssertLess(string input, string expected, Parser parser)
        {
            var env = DefaultEnv();
        ...
        {
            return Evaluate(input, DefaultParser(), DefaultEnv());
        }

        public string Evaluate(string input, Parser parser, Env env)
        {
